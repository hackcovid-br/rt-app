...
## Implementation`
  ...
  main.variable(observer("legend")).define("legend", ["d3", "ramp"], function (d3, ramp) {
    return (
      function legend({
        color,
        title,
  ...
  main.variable(observer("swatches")).define("swatches", ["DOM", "html", "entity"], function (DOM, html, entity) {
    return (
      function swatches({
        color,
        columns = null,

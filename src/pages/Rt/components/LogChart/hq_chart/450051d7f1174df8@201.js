...
`
  ...
  main.variable(observer("viewof i")).define("viewof i", ["Scrubber", "numbers"], function (Scrubber, numbers) {
    return (
      Scrubber(numbers)
    )
  });
  ...
  main.variable(observer()).define(["md", "i"], function (md, i) {
    return (
...
Scrubber has several options which you can pass as the second argument.`
  ...
  main.variable(observer("viewof date")).define("viewof date", ["Scrubber", "dates"], function (Scrubber, dates) {
    return (
      Scrubber(dates, {
        autoplay: false,
...
## Implementation`
  ...
  main.variable(observer("Scrubber")).define("Scrubber", ["html", "disposal"], function (html, disposal) {
    return (

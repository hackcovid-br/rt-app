  ...
  return (
    <div className="container hero-container">
      ...
      <p className="answerRt">
        ...
        quando t = 0. O problema do R<sub>0</sub> é que ele não adapta a mudanças de
        comportamento ou restrições governamentais e sociais, ele é fixo. Na
        forma que a pandemia evolui e as restrições aumentam ou diminuem, o R<sub>t</sub> também muda.
